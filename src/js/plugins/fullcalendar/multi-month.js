        ...
        createElement("table", {
          ...
          createElement("tbody", {role: "rowgroup"},
            createElement(TableRows, Object.assign({}, slicedProps, {
              ...
              dayMaxEvents: options.hasOwnProperty('dayMaxEvents') ? options.dayMaxEvents : !forPrint,
              dayMaxEventRows: options.hasOwnProperty('dayMaxEventRows') ? options.dayMaxEventRows : !forPrint,
