...
Similarly, you can use [flexbox utilities]({{< docsref "/utilities/flex" >}}) and [icons]({{< docsref "/components/icons" >}}) to create alerts with icons. Depending on your icons and content, you may want to add more utilities or custom styles.
